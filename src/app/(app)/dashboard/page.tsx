import {
  LayoutDashboard, Boxes, AlertTriangle, TrendingUp, Package, Activity,
} from "lucide-react";
...
export default async function DashboardPage() {
  ...
  // Insumos bajo stock mínimo (filtro JS porque SQLite no soporta comparar dos campos en where)
